...
returnResultsMCJointTest <- function(int.ns = 300, x.jump,jump,a.2,dim,n,cov.z,frac.jump = "Half",bool.mutePrint=FALSE,int.J = 3,bool.maxTest=FALSE,bool.maxTestVinv=FALSE,bool.knownV=FALSE,fun.adjustBand=NULL,bool.chisqStd=FALSE)
{
  library("rdrobust")
  library("rddensity")
  library("ggplot2")
  ...
  for (loop in 1:ns)
  {
    ...
    list.resultJointTest <- returnResultsJointTest(df.data=data,int.dimZ=options$int.dimZ,int.J=int.J,bool.maxTest=bool.maxTest,bool.maxTestVinv=bool.maxTestVinv,bool.knownV=bool.knownV,real.covZ=cov.z,fun.adjustBand=fun.adjustBand,bool.chisqStd=bool.chisqStd)
    #
