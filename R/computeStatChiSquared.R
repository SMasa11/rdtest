####
#' return chiSquared statistics for covariates balance
#'
...
computeStatChiSquared <- function(df.data,int.dimZ,bool.joint,int.J,bool.knownV=FALSE,real.covZ=NULL,fun.adjustBand=NULL,bool.chisqStd=FALSE)
{
