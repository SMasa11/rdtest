...
fun.runnerJoint = function(str.spec)
{
  ...
  #tic(str.spec)
  time.start <- Sys.time()
  eval(parse(text = paste0(paste0("list.summary <- return_results_MC_joint(",str.spec),")")))
  time.end <- Sys.time()
  #toc()
...
fun.repeaterJoint <- function(n,cov_z,dim,x_jump,z_jump,bool_max_test,bool_max_test_V_inv,bool_L2_std = FALSE,counter,df.resultJointTest,frac_jump,spec) {
    ...
    df.resultJointTest <- rbind(df.resultJointTest,
                                 ...
                                 vec.maxTestInvSpec = bool_max_test_V_inv,
...
#         # bool_max_test TRUE, bool_max_test_V_inv FALSE
#         for (x_jump in vec.xJump) {
#           for (z_jump in vec.zJump) {
#             if ((x_jump > 0.000001) | (x_jump == 0 & z_jump == 0)) {
#                 spec <- paste0("int_ns=",3000,",a_2=",0,",x_jump=",x_jump,",jump=",z_jump,",dim=",dim,",n=",n,",cov_z =", cov_z,",frac_jump=",frac_jump,",bool_mutePrint=TRUE,bool_max_test=",TRUE,",bool_max_test_V_inv=",FALSE)
#                 df.resultJointTest <- fun.repeaterJoint(n = n,cov_z = cov_z,dim = dim,x_jump = x_jump,z_jump = z_jump,bool_max_test = TRUE,bool_max_test_V_inv=FALSE,counter = counter,df.resultJointTest = df.resultJointTest,frac_jump = frac_jump,spec = spec)
#                 counter <- counter + 1
#             }
#           }
#         }
...
#           for (z_jump in vec.zJump) {
#             if ((x_jump > 0.000001) | (x_jump == 0 & z_jump == 0)) {
#                 spec <- paste0("int_ns=",3000,",a_2=",0,",x_jump=",x_jump,",jump=",z_jump,",dim=",dim,",n=",n,",cov_z =", cov_z,",frac_jump=",frac_jump,",bool_mutePrint=TRUE,bool_max_test=",TRUE,",bool_max_test_V_inv=",TRUE)
#                 df.resultJointTest <- fun.repeaterJoint(n = n,cov_z = cov_z,dim = dim,x_jump = x_jump,z_jump = z_jump,bool_max_test = TRUE,bool_max_test_V_inv=TRUE,counter = counter,df.resultJointTest = df.resultJointTest,frac_jump = frac_jump,spec = spec)
#                 counter <- counter + 1
#             }
#           }
#         }
...
#           for (z_jump in vec.zJump) {
#             if ((x_jump > 0.000001) | (x_jump == 0 & z_jump == 0)) {
#                 spec <- paste0("int_ns=",3000,",a_2=",0,",x_jump=",x_jump,",jump=",z_jump,",dim=",dim,",n=",n,",cov_z =", cov_z,",frac_jump=",frac_jump,",bool_mutePrint=TRUE,bool_max_test=",FALSE,",bool_max_test_V_inv=",FALSE)
#                 df.resultJointTest <- fun.repeaterJoint(n = n,cov_z = cov_z,dim = dim,x_jump = x_jump,z_jump = z_jump,bool_max_test = FALSE,bool_max_test_V_inv=FALSE,counter = counter,df.resultJointTest = df.resultJointTest,frac_jump = frac_jump,spec = spec)
#                 counter <- counter + 1
#             }
#           }
#         }
...
#           for (z_jump in vec.zJump) {
#             if ((x_jump > 0.000001) | (x_jump == 0 & z_jump == 0)) {
#                 spec <- paste0("int_ns=",3000,",a_2=",0,",x_jump=",x_jump,",jump=",z_jump,",dim=",dim,",n=",n,",cov_z =", cov_z,",frac_jump=",frac_jump,",bool_mutePrint=TRUE,bool_max_test=",FALSE,",bool_max_test_V_inv=",FALSE,",bool_L2_std=",TRUE)
#                 df.resultJointTest <- fun.repeaterJoint(n = n,cov_z = cov_z,dim = dim,x_jump = x_jump,z_jump = z_jump,bool_max_test = FALSE,bool_max_test_V_inv=FALSE,counter = counter,df.resultJointTest = df.resultJointTest,frac_jump = frac_jump,spec = spec,bool_L2_std=TRUE)
#                 counter <- counter + 1
#             }
#           }
#         }
...
fun.runnerJoint = function(str.spec)
{
  ...
  #tic(str.spec)
  time.start <- Sys.time()
  eval(parse(text = paste0(paste0("list.summary <- return_result_MC_joint(",str.spec),")")))
  time.end <- Sys.time()
  #toc()
  message((time.end - time.start)," min")
  return(list.summary)
...
df.coverage_0_500 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0),c(1,3:7,9)]
df.coverage_5_500 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0.5),c(1,3:7,9)]
df.coverage_9_500 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0.9),c(1,3:7,9)]

df.coverage_both <- df.coverage

#table_latex <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0.9),c(1,3:7,9)] %>% gt() %>% as_latex() %>% as.character()
#print(table_latex)
...
df.coverage <- data.frame(n=df.resultJointTest[,5],cov=df.resultJointTest[,3],dim=df.resultJointTest[,4],p.naive=df.resultJointTest[,8],p.bonferroni=df.resultJointTest[,9],p.joint=df.resultJointTest[,10],isMaxTest=df.resultJointTest[,11],isMaxInv=df.resultJointTest[,12],isChiStd=df.resultJointTest[,13])
df.coverage %>% gt()
df.coverage_0_1000 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0),c(1,3:7,9)]
df.coverage_5_1000 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0.5),c(1,3:7,9)]
df.coverage_9_1000 <- df.coverage[(df.coverage$isMaxInv==FALSE) & (df.coverage$cov == 0.9),c(1,3:7,9)]
            ...
            rbind(
              data.frame(
                ...
                prob = df.coverage_both[df.coverage_both$n == n &
                                        ...
                                        df.coverage_both$isMaxInv == FALSE &
