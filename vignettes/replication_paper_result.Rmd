...
df.coverage_0_500 <- df.coverage[(df.coverage$cov == 0),c(1,3:8)]
df.coverage_5_500 <- df.coverage[(df.coverage$cov == 0.5),c(1,3:8)]
df.coverage_9_500 <- df.coverage[(df.coverage$cov == 0.9),c(1,3:8)]
...
df.coverage <- data.frame(n=df.resultJointTest[,5],cov=df.resultJointTest[,3],dim=df.resultJointTest[,4],p.naive=df.resultJointTest[,8],p.bonferroni=df.resultJointTest[,9],p.joint=df.resultJointTest[,10],isMaxTest=df.resultJointTest[,11],isChiStd=df.resultJointTest[,12])
df.coverage %>% gt()
df.coverage_0_1000 <- df.coverage[(df.coverage$cov == 0),c(1,3:8)]
df.coverage_5_1000 <- df.coverage[(df.coverage$cov == 0.5),c(1,3:8)]
df.coverage_9_1000 <- df.coverage[(df.coverage$cov == 0.9),c(1,3:8)]
