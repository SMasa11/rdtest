...
has has two implications: continuous density function and balancing of
pre-treatment covariates. Violation of any of these testable restriction raises
aa concern on the sufficient condition. (Nevertheless, these testable
...
the density satisfy the continuity condition as designed.
